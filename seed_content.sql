...
(
    ...
    'https://images.unsplash.com/photo-1605901309584-818e25960b8f?q=80&w=1632&auto=format&fit=crop',
    'Gaming',
...
(
    ...
    'https://images.unsplash.com/photo-1612287230287-63aeb949938d?q=80&w=1632&auto=format&fit=crop',
    'Gaming',
    'd0ec9c36-0001-4444-8888-000000000003', 'Mike Ross', 'https://api.dicebear.com/7.x/avataaars/svg?seed=Mike',
    NOW() - INTERVAL '3 days',
    7, 2100, 85
