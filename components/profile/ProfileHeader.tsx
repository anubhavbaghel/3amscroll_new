            ...
            <div className="h-48 md:h-64 w-full bg-gradient-to-r from-gray-800 to-gray-900 overflow-hidden relative group">
                ...
                {isOwnProfile && (
                    <button
                        ...
                        className="absolute top-4 right-4 bg-black/50 hover:bg-black/70 text-white px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100"
                    >
                        Edit Profile
                    </button>
                )}
