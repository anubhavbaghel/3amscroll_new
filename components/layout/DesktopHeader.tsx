                        ...
                        <div className="flex items-center justify-end gap-3">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-48 xl:w-64 px-4 py-2 pl-10 rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all"
                                />
                                <svg
